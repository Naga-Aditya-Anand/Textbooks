...
import appinventor.ai_chnagaaditya.Textbooks.X.XEQP;
import appinventor.ai_chnagaaditya.Textbooks.X.XHQP;
import appinventor.ai_chnagaaditya.Textbooks.X.XMQP;
import appinventor.ai_chnagaaditya.Textbooks.X.XSCQP;
import appinventor.ai_chnagaaditya.Textbooks.X.XSSQP;


public class Qpaper_Fragment extends Fragment implements NavigationView.OnNavigationItemSelectedListener {
    ...
    CardView english, maths, science, social, hindi;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_qpaper_, container, false);
        ...
        english.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getActivity(), XEQP.class);
        ...
        maths.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getActivity(), XMQP.class);
                startActivity(intent);
            }
        });
        ...
        science.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getActivity(), XSCQP.class);
                startActivity(intent);
            }
        });
        ...
        social.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getActivity(), XSSQP.class);
                startActivity(intent);
            }
        });
        ...
        hindi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getActivity(), XHQP.class);
                startActivity(intent);
            }
        });
